...
class Record:
    def __init__(
        self, name, phone=None, birthday=None, email=None, address=None, note=None
    ):
    ...
    def days_to_birthday(self):
        ...
        next_birthday = datetime.date(
            current_date.year, self.birthday.value.month, self.birthday.value.day
        )
...
class AddressBook(UserDict):
    ...
    def iterator(
        self, n
    ):  # n-number of records per page. is defined in show_page function
        contacts_per_page = n
